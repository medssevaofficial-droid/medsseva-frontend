...
sendForgotPasswordOtp: (email: string) => api.post('/auth/email/forgot-password', { email }).then(res => res.data),
  ...
  sendForgotPasswordOtpMobile: (mobile: string) => api.post('/auth/mobile/forgot-password', { mobile }).then(res => res.data),
  verifyForgotPasswordOtpMobile: (mobile: string, otp: string) => api.post('/auth/mobile/verify-reset-otp', { mobile, otp }).then(res => res.data),
  resetPasswordMobile: (mobile: string, password: string) => api.post('/auth/mobile/reset-password', { mobile, password }).then(res => res.data),
